...
<div class="wrap">
    <?php
    NavBar::begin([
        'brandLabel' => 'Админ-панель TechPlace',
        ...
        <div class="col-md-12">
            <div class="col-md-4">
                <?= PanelMenu::widget(['items' => [
                    ...
                    ['label' => 'Посты', 'url' => ['/admin/lesson']],
                    ['label' => 'Заявки на рекламу', 'url' => ['/admin/advertising']],
                ],
                    'heading' => 'Меню админ-панели',
                    'type' => 'panel-default',
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; TechPlace <?= date('Y') ?></p>
